...
namespace Hamburgueria.Repositories
{
    public class PedidoRepository : BaseRepository
    {
        ...
        private Pedido ConverterEmObjeto(string registro)
        {
            ...
            pedido.Hamburguer.Preço = double.Parse(ExtrairCampo("hamburguerPreco", registro));
            pedido.Shake.Nome = ExtrairCampo("shakeNome", registro);
            pedido.Shake.Preço = double.Parse(ExtrairCampo("shakePreco", registro));
        ...
        private string PrepararRegistroCSV(Pedido pedido)
        {
            ...
            return $"id={id};clienteNome={pedido.Cliente.Nome};clienteEndereco={pedido.Cliente.Endereco};clienteTelefone={pedido.Cliente.Telefone};clienteEmail={pedido.Cliente.Email};hamburguerNome={pedido.Hamburguer.Nome};hamburguerPreco={pedido.Hamburguer.Preço};shakeNome={pedido.Shake.Nome};shakePreco={pedido.Shake.Preço};dataPedido={pedido.DataPedido};precoTotal={pedido.PrecoTotal}\n";
        }
    }
}